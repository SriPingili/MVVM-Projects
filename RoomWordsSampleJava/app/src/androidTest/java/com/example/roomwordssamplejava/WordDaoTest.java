package com.example.roomwordssamplejava;
...
import com.example.roomwordssamplejava.db.WordRoomDatabase;
import com.example.roomwordssamplejava.db.dao.WordDao;
import com.example.roomwordssamplejava.db.entity.Word;
...
public class WordDaoTest {
    ...
    public void insertAndGetWord() throws Exception {
        ...
        List<Word> allWords = LiveDataTestUtil.getValue(mWordDao.getAllWords());
